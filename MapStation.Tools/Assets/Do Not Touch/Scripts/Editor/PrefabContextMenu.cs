...
public class AddPrefabsToContextMenu {
    ...
    [MenuItem("GameObject/" + Constants.menuLabel + "/Door Teleport", priority = Priority)]
    ...
    [MenuItem("GameObject/" + Constants.menuLabel + "/Out-of-Bounds Teleport", priority = Priority)]
    ...
    [MenuItem("GameObject/" + Constants.menuLabel + "/Small Graffiti Spot", priority = Priority)]
    ...
    [MenuItem("GameObject/" + Constants.menuLabel + "/Medium Graffiti Spot", priority = Priority)]
    ...
    [MenuItem("GameObject/" + Constants.menuLabel + "/Large Graffiti Spot", priority = Priority)]
    ...
    [MenuItem("GameObject/" + Constants.menuLabel + "/Extra Large Graffiti Spot", priority = Priority)]
